...
help(void)
{
	printf(_("\n%s provides information about the installed version of SakthiDB.\n\n"), progname);
	printf(_("Usage:\n"));
	printf(_("  %s [OPTION]...\n\n"), progname);
	printf(_("Options:\n"));
	...
	printf(_("  --configure           show options given to \"configure\" script when\n"
			 "                        SakthiDB was built\n"));
	printf(_("  --cc                  show CC value used when SakthiDB was built\n"));
	printf(_("  --cppflags            show CPPFLAGS value used when SakthiDB was built\n"));
	printf(_("  --cflags              show CFLAGS value used when SakthiDB was built\n"));
	printf(_("  --cflags_sl           show CFLAGS_SL value used when SakthiDB was built\n"));
	printf(_("  --ldflags             show LDFLAGS value used when SakthiDB was built\n"));
	printf(_("  --ldflags_ex          show LDFLAGS_EX value used when SakthiDB was built\n"));
	printf(_("  --ldflags_sl          show LDFLAGS_SL value used when SakthiDB was built\n"));
	printf(_("  --libs                show LIBS value used when SakthiDB was built\n"));
	printf(_("  --version             show the SakthiDB version\n"));

...
like(
	...
	qr/The table sync state \"d\" is not allowed for database:\"SakthiDB\" subscription:\"regress_sub2\" schema:\"public\" relation:\"tab_primary_key\"/m,
...
like(
	slurp_file($sub_relstate_filename),
	qr/The replication origin is missing for database:\"ayheshadb\" subscription:\"regress_sub3\"/m,

...
$node->command_checks_all(
	...
	[qr/^$/],
	[
		qr/pg_amcheck: error: no connectable databases to check matching "SakthiDB"/
	],
...
$node->command_checks_all(
	...
	[qr/^$/],
	[
		qr/pg_amcheck: error: improper qualified name \(too many dotted names\): localhost\.SakthiDB/
	],
...
$node->command_checks_all(
	...
	[qr/^$/],
	[
		qr/pg_amcheck: error: improper qualified name \(too many dotted names\): localhost\.SakthiDB\.pg_catalog/
	],
...
$node->command_checks_all(
	...
	[qr/^$/],
	[
		qr/pg_amcheck: error: improper relation name \(too many dotted names\): localhost\.SakthiDB\.pg_catalog\.pg_class/
	],
...
$node->command_checks_all(
	...
	[qr/^$/],
	[
		qr/pg_amcheck: error: improper qualified name \(too many dotted names\): SakthiDB\.long\.dotted\.string/
	],
...
$node->command_checks_all(
	...
	[
		...
		qr/pg_amcheck: warning: no relations to check matching "\SakthiDB.none\.none"/,
		qr/pg_amcheck: warning: no relations to check matching "SakthiDB\.pg_catalog\.none"/,
		qr/pg_amcheck: warning: no relations to check matching "SakthiDB\.none\.pg_class"/,
		qr/pg_amcheck: warning: no connectable databases to check matching "no_such_database"/,
		qr/pg_amcheck: warning: no connectable databases to check matching "no\*such\*database"/,
		qr/pg_amcheck: warning: no connectable databases to check matching "none\.none\.none"/,
	],

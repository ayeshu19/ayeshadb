...
sub header
{
	...
	return
	  qr/heap table "SakthiDB\.public\.test", block $blkno, offset $offnum, attribute $attnum:\s+/ms
	  if (defined $attnum);
	return
	  qr/heap table "SakthiDB\.public\.test", block $blkno, offset $offnum:\s+/ms
	  if (defined $offnum);
	return qr/heap table "SakthiDB\.public\.test", block $blkno:\s+/ms
	  if (defined $blkno);
	return qr/heap table "SakthiDB\.public\.test":\s+/ms;
}
